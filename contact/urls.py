...
urlpatterns = [
    ...
    path('create/', views.ContactCreateView.as_view(), name="create-contact"),
    path('update/<int:pk>/',
    ...
    path('export-csv/<int:account_pk/',
         views.generate_contact_csv, name='export-csv'),
    path('import-csv/<int:account_pk>/', views.import_csv, name="import-csv")
]
